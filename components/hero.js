          ...
          <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
            <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start">
              ...
              <div className="md:block md:ml-10 md:pr-4">
                ...
                <a
                  href="/"
                  className="ml-8 font-medium text-black-500 hover:text-black-900 transition duration-150 ease-in-out hover:bg-blue-accent rounded-md bg-orange-accent bg-opacity-25 p-2"
                >
                  Home
                </a>
                <a
